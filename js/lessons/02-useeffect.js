...
export default {
  ...
  guided: {
    ...
    starter: [
      ...
      "",
      "  useEffect(() => {",
      "    // STEP 3 · the cancelled flag goes here",
      "",
      "    mockApi.listJobs()",
      "      .then(data => {",
      "        // STEP 4 · the guard goes here",
      "        setJobs(data);",
      "        setStatus('ready');",
      "      });",
      "    // STEP 2 · error handling goes here, chained onto the promise above",
      "",
      "    // STEP 5 · the cleanup goes here",
      "  });                                    // STEP 1 · no dependency array — this re-runs after every render",
      "",
